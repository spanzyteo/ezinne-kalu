    ...
    <div className="lg:ml-[360px] lg:py-16 px-10 lg:px-16">
      ...
      <div className="flex flex-col gap-4 mt-8">
        ...
        <div className="flex flex-col mt-2">
          <h1 className="font-semibold text-[30px] text-gray-700">whereami</h1>
          <ul className="list-disc list-inside space-y-2 ml-6 text-gray-600">
            <li>
        ...
        <div className="flex flex-col mt-2">
          <h1 className="font-semibold text-[30px] text-gray-700">affiliations</h1>
          <ul className="list-disc list-inside space-y-2 ml-6 text-gray-600">
            <li>
